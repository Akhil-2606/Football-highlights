...
input_directory = "VideoA.mp4"  # Change this to the directory containing your video files
...
if os.path.isdir(input_directory):
    for filename in os.listdir(input_directory):
        if filename.lower().endswith('.mp4'):
            ...
            process_video(input_directory)
else:
    # If input_directory is a single file, process it directly
    process_video(input_directory)